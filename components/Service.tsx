            ...
            <div className="">
              <ul className="md:grid md:grid-cols-3 md:gap-6">
                <li className="md:mb-0 mb-10">
                  ...
                  <Image src="/img/11.png" alt="Icon" width={300} height={300} className="mb-4 w-1/5 mx-auto" />
                ...
                <li className="md:mb-0 mb-10">
                  ...
                  <Image src="/img/13.png" alt="Icon" width={300} height={300} className="mb-4 w-1/5 mx-auto" />
                ...
                <li className="">
                  ...
                  <Image src="/img/12.png" alt="Icon" width={300} height={300} className="mb-4 w-1/5 mx-auto" />
